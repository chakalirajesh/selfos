...
public class UpdateHabitRequest {
    ...
    @Min(value = 0, message = "Streak count metric cannot drop below 0")
    private Integer streakCount;

    @NotBlank(message = "Status state condition is required")
    @Pattern(regexp = "^(ACTIVE|PAUSED|COMPLETED)$", 
             message = "Status value must match one of: ACTIVE, PAUSED, or COMPLETED")
